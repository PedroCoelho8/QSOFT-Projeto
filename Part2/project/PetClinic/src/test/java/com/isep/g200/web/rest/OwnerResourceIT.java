...
import com.isep.g200.repository.OwnerRepository;
import com.isep.g200.service.dto.OwnerDTO;
import com.isep.g200.service.mapper.OwnerMapper;
...
class OwnerResourceIT {
    ...
    void partialUpdateOwnerWithPatch() throws Exception {
        ...
        partialUpdatedOwner.city(UPDATED_CITY).firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).telephone(UPDATED_TELEPHONE);
